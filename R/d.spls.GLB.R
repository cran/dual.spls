#' Dual Sparse Partial Least Squares (Dual-SPLS) regression for the group lasso norm B
#' @keywords internal
#' @description
...
#' Dual-SPLS algorithm with the norm \deqn{\Omega(w)=\|w\|_2+\sum_{g=1}^G \lambda_g\|w_g\|_1} for combined data.
